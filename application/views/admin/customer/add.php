...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
			<div class="row">
				<div class="col-md-6">
					<form role="form" method="post" action="<?php echo base_url('index.php/customer/doAdd')?>" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label>Alamat</label>
							<textarea class="form-control" name="alamat_cust" id="alamat_cust"></textarea>
						</div>
						
						<div class="form-group">
							<label>Nomor Hp</label>
							<input type="text" min="0" name="nohp_cust" id="nohp_cust" class="form-control">
						</div>
