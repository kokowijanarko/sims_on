    ...
    <div class="box">
        ...
        <div class="box-body">
			...
			<div style="float:right" class="col-md-2">
				<a href="<?php echo base_url('index.php/supplier/add')?>" ><button type="button" class="btn btn-block btn-success btn-sm">Tambah Supplier</button></a>
			</div>
			</br>
			</br>
                ...
                <tbody>
					<?php
						...
						foreach($list as $value){
							...
							echo '<td>'.$value->alamat_sup.'</td>';
							echo '<td>'.$value->nohp_sup.'</td>';
							echo '<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="'.site_url('supplier/edit/'.$value->id_sup).'">Edit</a></li>
										<li><a href="'.site_url('supplier/doDelete/'.$value->id_sup).'">Hapus</a></li>
									</ul>
								</div>
